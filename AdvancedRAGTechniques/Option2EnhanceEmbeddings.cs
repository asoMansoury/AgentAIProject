...
namespace AdvancedRAGTechniques
{
    ...
    {
        public static async Task Run(bool importData, Movie[] movieDataForRag, 
                                      Microsoft.Extensions.AI.ChatMessage question,
            ...
            AIAgent agent = client.GetChatClient(secrets.ChatDeploymentName)
                .AsAIAgent(
                    instructions: """
                              ...
                              """,
                    tools: [AIFunctionFactory.Create(searchTool.SearchVectoreStore)])
                .AsBuilder()
