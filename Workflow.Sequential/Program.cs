...
AIAgent summaryAgent = chatClient.AsAIAgent(name: "SummaryAgent", instructions: "Summarize the text you are given to max 200 words");
AIAgent translationAgent = chatClient.AsAIAgent(name: "TranslationAgent", instructions: "Given a text Translate it to French");
